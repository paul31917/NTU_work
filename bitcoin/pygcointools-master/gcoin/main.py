...
def encode_license(license):
    ...
    `fee_collector`, `metadata_link`, 'member_control`. All the other
    fields are hard-coded by this encoder because they have no effect on
    current gcoin core yet.
    ...
    result += b'01' if license['member_control'] else b'00'  # hardcode member control to 'true'
